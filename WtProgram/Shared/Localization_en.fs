...
module Localization_en =
    let strings = dict [
        ...
        ("Down", "Down")
        ("Main", "Main")
        ("MoveTab", "Move tab to another group")
        ("MoveTabGroup", "Reposition tab group")
        ...
        ("HideWhenMaximized", "Hide after specified time when maximized only")
        ("HideWhenDown", "Always hide after specified time (including maximized)")
